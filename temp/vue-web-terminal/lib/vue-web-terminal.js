...
import { defineComponent, openBlock, createElementBlock, createElementVNode, toDisplayString, createCommentVNode, pushScopeId, popScopeId, unref, normalizeClass, reactive, createBlock, withDirectives, Fragment, renderList, vModelSelect, computed, resolveComponent, createVNode, ref, normalizeStyle, createTextVNode, onMounted, onUnmounted, watch, nextTick, renderSlot, withKeys, vModelDynamic, vShow, withModifiers, vModelText } from "vue";
const scrollbar = "";
const ansi = "";
const style$1 = "";
const style = "";
...
class TerminalStore {
  constructor(key) {
    __publicField(this, "storageKey", DEFAULT_STORAGE_KEY);
  ...
  push(name, cmd) {
    ...
    if (data2.cmdLog.length === 0 || data2.cmdLog[data2.cmdLog.length - 1] !== cmd) {
      ...
      if (data2.cmdLog.length > MAX_STORE_SIZE) {
        data2.cmdLog.splice(0, data2.cmdLog.length - MAX_STORE_SIZE);
      }
    }
    data2.cmdIdx = data2.cmdLog.length;
    this.store();
  }
  store() {
  ...
  getData(name) {
    let data2 = this.dataMap[name];
    if (data2 == null) {
      data2 = {};
      this.dataMap[name] = data2;
    }
    return data2;
  }
  getLog(name) {
  ...
  getIdx(name) {
    let data2 = this.getData(name);
    return data2.cmdIdx | 0;
  }
  setIdx(name, idx) {
    this.getData(name).cmdIdx = idx;
  }
}
let TerminalApi$1 = class TerminalApi {
  constructor(data2) {
...
const TerminalApi2 = new TerminalApi$1(data);
function _html(str) {
...
const ANSI_DESIGNATE_CHARSET_0 = ANSI_ESC + "(";
const ANSI_DESIGNATE_CHARSET_1 = ANSI_ESC + ")";
const ANSI_DESIGNATE_CHARSET_2 = ANSI_ESC + "*";
const ANSI_DESIGNATE_CHARSET_3 = ANSI_ESC + "+";
const ANSI_CHARSET = ANSI_ESC + "%";
const ANSI_DECD = ANSI_ESC + "#";
    ...
    try {
      ...
      for (let c of arr2) {
        ...
        if (data2.styleFlag.length > 0) {
          ...
          charStr = `<span class="${clazz}" style="${data2.attachStyle}">${c}</span>`;
        } else {
          charStr = `<span class="${clazz}" style="${data2.attachStyle}">${c}</span>`;
        }
...
const _withScopeId = (n) => (pushScopeId("data-v-197040ed"), n = n(), popScopeId(), n);
const _hoisted_1$7 = { class: "t-header" };
const _hoisted_2$7 = { style: { "display": "inline-block" } };
const _hoisted_3$6 = { class: "t-shell-dots" };
const _hoisted_4$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("svg", {
  t: "1645078279626",
  class: "t-shell-dot",
...
const _hoisted_6$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("svg", {
  t: "1645078503601",
  class: "t-shell-dot",
  viewBox: "0 0 1024 1024",
  version: "1.1",
...
const _hoisted_8$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("svg", {
  t: "1645078604258",
  class: "t-shell-dot",
  viewBox: "0 0 1024 1024",
  version: "1.1",
...
const _hoisted_11$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("path", {
...
const _hoisted_14$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("path", {
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    const _triggerClick = (type) => {
      emits("on-click", type);
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createElementVNode("h4", _hoisted_2$7, [
          createElementVNode("span", {
            onClick: _cache[0] || (_cache[0] = ($event) => _triggerClick("title")),
            class: "t-disable-select",
            style: { "cursor": "pointer" }
          }, toDisplayString(__props.title), 1)
        ]),
        createElementVNode("ul", _hoisted_3$6, [
          createElementVNode("li", {
            class: "shell-dot-item t-shell-dots-red",
            onClick: _cache[1] || (_cache[1] = ($event) => _triggerClick("close"))
          }, _hoisted_5$3),
          createElementVNode("li", {
            class: "shell-dot-item t-shell-dots-yellow",
            onClick: _cache[2] || (_cache[2] = ($event) => _triggerClick("minScreen"))
          }, _hoisted_7$2),
          createElementVNode("li", {
            class: "shell-dot-item t-shell-dots-green",
            onClick: _cache[3] || (_cache[3] = ($event) => _triggerClick("fullScreen"))
          }, _hoisted_9$2)
        ]),
        __props.draggable ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "t-header-pin",
          onClick: _cache[4] || (_cache[4] = ($event) => _triggerClick("pin"))
        }, [
          __props.pinned ? (openBlock(), createElementBlock("svg", _hoisted_10$2, _hoisted_12$1)) : (openBlock(), createElementBlock("svg", _hoisted_13$1, _hoisted_15$1))
        ])) : createCommentVNode("", true)
      ]);
    };
  }
});
const THeader_vue_vue_type_style_index_0_scoped_197040ed_lang = "";
...
const THeader = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-197040ed"]]);
const _hoisted_1$6 = { class: "t-content-normal" };
const _hoisted_2$6 = ["innerHTML"];
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  __name: "TViewerNormal",
  props: {
    message: Object,
    idx: [Number, String]
  },
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", _hoisted_1$6, [
        unref(_nonEmpty)(__props.message.tag == null ? __props.message.class : __props.message.tag) ? (openBlock(), createElementBlock("span", {
          key: 0,
          class: normalizeClass(__props.message.class),
          style: { "margin-right": "10px" }
        }, toDisplayString(__props.message.tag == null ? __props.message.class : __props.message.tag), 3)) : createCommentVNode("", true),
        createElementVNode("span", {
...
(function(module, exports) {
  !function(e, t) {
    module.exports = t(require$$0, requireClipboard());
  }(commonjsGlobal, function(n, o) {
...
var vueJsonViewerExports = vueJsonViewer.exports;
const JsonViewer = /* @__PURE__ */ getDefaultExportFromCjs(vueJsonViewerExports);
const _hoisted_1$5 = {
  style: { "position": "relative" },
  class: "t-json-container"
};
const _hoisted_2$5 = /* @__PURE__ */ createElementVNode("option", {
  value: "",
  disabled: "",
  selected: "",
  hidden: "",
...
const _hoisted_3$5 = ["label", "value"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", _hoisted_1$5, [
        (openBlock(), createBlock(unref(JsonViewer), {
          "expand-depth": __props.message.depth,
          sort: "",
          copyable: "",
          expanded: "",
          key: __props.idx + "_" + __props.message.depth,
          value: unref(_parseToJson)(__props.message.content)
        }, null, 8, ["expand-depth", "value"])),
        withDirectives(createElementVNode("select", {
          class: "t-json-deep-selector",
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => __props.message.depth = $event)
        }, [
          _hoisted_2$5,
          (openBlock(true), createElementBlock(Fragment, null, renderList(jsonViewDepth, (i) => {
          ...
          [vModelSelect, __props.message.depth]
        ])
      ]);
    };
  }
});
const _hoisted_1$4 = { class: "t-code" };
const _hoisted_2$4 = {
  key: 0,
  class: "t-vue-highlight"
};
const _hoisted_3$4 = {
  key: 1,
  class: "t-vue-codemirror"
};
const _hoisted_4$2 = {
  key: 2,
  class: "t-code-default"
};
const _hoisted_5$2 = { style: { "padding": "1em", "margin": "0" } };
const _hoisted_6$2 = { style: { "font-size": "15px" } };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        getHighlight.value ? (openBlock(), createElementBlock("div", _hoisted_2$4, [
          createVNode(_component_highlightjs, {
            ref: "highlightjs",
            autodetect: "",
            code: __props.message.content
          }, null, 8, ["code"])
        ])) : getCodemirror.value ? (openBlock(), createElementBlock("div", _hoisted_3$4, [
          createVNode(_component_codemirror, {
            ref: "codemirror",
            modelValue: __props.message.content,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => __props.message.content = $event),
            options: getCodemirror.value
          }, null, 8, ["modelValue", "options"])
        ])) : (openBlock(), createElementBlock("div", _hoisted_4$2, [
          createElementVNode("pre", _hoisted_5$2, [
            createElementVNode("code", _hoisted_6$2, toDisplayString(__props.message.content), 1)
          ])
        ]))
      ]);
    };
...
const _hoisted_1$3 = { class: "t-table t-border-dashed" };
const _hoisted_2$3 = { class: "t-border-dashed" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("table", _hoisted_1$3, [
        createElementVNode("thead", null, [
          createElementVNode("tr", _hoisted_2$3, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.message.content.head, (it) => {
              return openBlock(), createElementBlock("td", {
                key: it,
                class: "t-border-dashed"
              }, toDisplayString(it), 1);
            }), 128))
          ])
        ]),
        createElementVNode("tbody", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.message.content.rows, (row, idx) => {
            return openBlock(), createElementBlock("tr", {
              key: idx,
              class: "t-border-dashed"
            }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(row, (it, idx2) => {
                return openBlock(), createElementBlock("td", {
                  key: idx2,
                  class: "t-border-dashed"
                }, [
                  createElementVNode("div", { innerHTML: it }, null, 8, _hoisted_3$3)
                ]);
              }), 128))
            ]);
          }), 128))
...
const _hoisted_5$1 = { class: "t-cmd-help-eg" };
const _hoisted_6$1 = { class: "t-cmd-help-example" };
const _hoisted_7$1 = { class: "t-example-ul" };
const _hoisted_8$1 = { class: "t-example-li" };
const _hoisted_9$1 = { class: "t-example-li" };
const _hoisted_10$1 = {
  key: 0,
  class: "t-cmd-help-des"
};
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "t-cmd-help",
        ref_key: "terminalHelpBoxRef",
        ref: terminalHelpBoxRef,
        style: normalizeStyle(`top: ${__props.top}px;max-height: calc(100% - ${__props.top}px);`)
      }, [
        __props.result.item.description ? (openBlock(), createElementBlock("p", {
          key: 0,
          class: "text",
          style: { "margin": "15px 0" },
          innerHTML: __props.result.item.description
        }, null, 8, _hoisted_1$2)) : createCommentVNode("", true),
        __props.result.item.example && __props.result.item.example.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.result.item.example, (it, idx) => {
            return openBlock(), createElementBlock("div", {
              key: idx,
              class: "text"
            }, [
              __props.result.item.example.length === 1 ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
                createElementVNode("span", null, [
                  createTextVNode("Example: "),
                  createElementVNode("code", null, toDisplayString(it.cmd), 1),
                  createTextVNode(" " + toDisplayString(it.des), 1)
                ])
              ])) : (openBlock(), createElementBlock("div", _hoisted_4$1, [
                createElementVNode("div", _hoisted_5$1, " eg" + toDisplayString(__props.result.item.example.length > 1 ? idx + 1 : "") + ": ", 1),
                createElementVNode("div", _hoisted_6$1, [
                  createElementVNode("ul", _hoisted_7$1, [
                    ...
                    createElementVNode("li", _hoisted_9$1, [
                      it.des != null ? (openBlock(), createElementBlock("span", _hoisted_10$1, toDisplayString(it.des), 1)) : createCommentVNode("", true)
                    ])
                  ])
                ])
              ]))
...
const _hoisted_1$1 = { class: "t-editor" };
const _hoisted_2$1 = ["value"];
const _hoisted_3$1 = {
  class: "t-text-editor-floor",
  align: "center"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createElementVNode("textarea", {
          ...
          autofocus: "",
          class: "t-text-editor",
          onInput: _updateModelValue,
          value: props.modelValue,
          onFocus: _cache[0] || (_cache[0] = //@ts-ignore
          (...args) => __props.config.onFocus && __props.config.onFocus(...args)),
          onBlur: _cache[1] || (_cache[1] = //@ts-ignore
          (...args) => __props.config.onBlur && __props.config.onBlur(...args))
        }, null, 40, _hoisted_2$1),
        createElementVNode("div", _hoisted_3$1, [
          createElementVNode("button", {
            class: "t-text-editor-floor-btn t-close-btn",
            onClick: _cache[2] || (_cache[2] = ($event) => _close(false)),
            title: "Cancel Edit"
          }, "Cancel "),
          createElementVNode("button", {
            class: "t-text-editor-floor-btn t-save-btn",
            onClick: _cache[3] || (_cache[3] = ($event) => _close(true)),
...
const TEditor_vue_vue_type_style_index_0_scoped_f962e199_lang = "";
const TEditor = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-f962e199"]]);
const _hoisted_1 = { key: 0 };
const _hoisted_2 = { class: "terminal" };
const _hoisted_3 = {
  key: 0,
  class: "t-crude-font t-cmd-line"
};
const _hoisted_4 = { class: "t-prompt t-cmd-line-content" };
...
const _hoisted_17 = ["type", "onKeyup"];
const _hoisted_18 = ["innerHTML"];
const _hoisted_19 = ["onKeyup"];
const _hoisted_20 = { class: "t-help-msg" };
const _hoisted_21 = { key: 1 };
const _hoisted_22 = { class: "t-flag t-crude-font t-cmd-line t-disable-select" };
const _sfc_main = /* @__PURE__ */ defineComponent({
    ...
    initLog: {
      ...
      default: () => {
        return [{
          ...
          type: "normal",
          content: "Current login time: " + (/* @__PURE__ */ new Date()).toLocaleString()
        }, {
          type: "normal",
  ...
  setup(__props, { expose: __expose, emit: emits }) {
    ...
    const draggable = computed(() => {
      return props.showHeader && props.dragConf != void 0;
    });
    const isPinned = computed(() => {
      return props.dragConf && props.dragConf.pinned;
    });
    const isActive = computed(() => {
      return cursorConf.show || ask.open && terminalAskInputRef.value === document.activeElement || textEditor.open && textEditor.focus;
    });
    ...
    onMounted(() => {
      ...
      _eventOn(terminalWindowRef.value, "contextmenu", (event) => {
        event.preventDefault();
      ...
      register(getName(), terminalListener.value = (type, options) => {
        if (type === "pushMessage") {
          ...
          let hasScroll = terminalWindowRef.value.scrollHeight > terminalWindowRef.value.clientHeight || terminalWindowRef.value.offsetHeight > terminalWindowRef.value.clientHeight;
          return {
            pos: _getPosition(),
            //  窗口所在位置
    ...
    const updateHeaderHeight = () => {
      nextTick(() => {
        if (terminalHeaderRef.value && terminalHeaderRef.value.getBoundingClientRect) {
          let rect = terminalHeaderRef.value.getBoundingClientRect();
    ...
    const _searchCmd = (key) => {
      if (!props.autoHelp) {
        return;
      }
      if (props.searchHandler) {
        props.searchHandler(allCommandStore.value, key, (cmd2) => {
          searchCmdResult.item = cmd2;
          _jumpToBottom();
        });
        return;
      }
      ...
      if (_isEmpty(cmd)) {
        ...
        for (const o of allCommandStore.value) {
          if (_nonEmpty(o.key)) {
            ...
            if (res != null) {
              let score = res.index * 1e3 + (cmd.length - res[0].length) + (o.key.length - res[0].length);
              if (score === 0) {
                target = o;
                break;
              } else {
    ...
    const _printHelp = (regExp, srcStr) => {
      let content = {
        head: ["KEY", "GROUP", "DETAIL"],
        rows: []
      };
      let findGroup = srcStr && srcStr.length > 1 && srcStr.startsWith(":") ? srcStr.substring(1).toLowerCase() : null;
      allCommandStore.value.forEach((cmd) => {
        ...
        if (cmd.example != null) {
          ...
          for (let idx2 in cmd.example) {
            let eg = cmd.example[idx2];
            detail += `
                        <div>
    ...
    const _filterMessageType = (message) => {
    ...
    const _appendMessage = (message) => {
      ...
      for (let i = terminalLog.value.length - 1; i >= 0; i--) {
        let message2 = terminalLog.value[i];
        if (message2.type !== "cmdLine") {
          lastMessage = message2;
          break;
        }
      }
      if (lastMessage) {
        if (lastMessage.type === "normal" || lastMessage.type === "ansi" || lastMessage.type === "code" || lastMessage.type == "html") {
    ...
    const _calculateCursorPos = (cmdStr) => {
      let idx2 = cursorConf.idx;
      let cmd = cmdStr ? cmdStr : command.value;
      _calculateByteLen();
      if (idx2 < 0 || idx2 >= cmd.length) {
        _resetCursorPos();
        return;
      }
    ...
    const _calculateStringWidth = (str) => {
      let width = 0;
      for (let char of str) {
    ...
    const _initContainerStyle = () => {
      ...
      if (draggable.value) {
        ...
        let height = confHeight ? parseInt(confHeight) : 500;
    ...
    const _initDrag = () => {
      ...
      let window2 = terminalWindowRef.value;
      ...
      const storeResizeData = (type, evt) => {
        isResize = true;
        window2.style["user-select"] = "none";
      ...
      _eventOn(document, "mouseup", () => {
        ...
        isDragging = false;
        isResize = false;
        window2.style["user-select"] = "unset";
      });
    };
    const _dragging = (x, y) => {
      if (isPinned.value) {
    ...
    __expose({
      ...
      dragging: _dragging,
      execute: (cmd) => {
        return TerminalApi2.execute(getName(), cmd);
      },
      focus: _focus,
      elementInfo: () => {
        return TerminalApi2.elementInfo(getName());
      },
      textEditorOpen: (options) => {
        return TerminalApi2.textEditorOpen(getName(), options);
      },
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass("t-container " + (isActive.value ? "" : "t-disable-select")),
        style: normalizeStyle(containerStyle.value),
        ref_key: "terminalContainerRef",
        ref: terminalContainerRef
      }, [
        draggable.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
          createElementVNode("div", {
            class: "t-point t-point-lt",
            ref_key: "resizeLTRef",
            ref: resizeLTRef
          }, null, 512),
          createElementVNode("div", {
            class: "t-point t-point-rt",
            ref_key: "resizeRTRef",
            ref: resizeRTRef
          }, null, 512),
          createElementVNode("div", {
            class: "t-point t-point-lb",
            ref_key: "resizeLBRef",
            ref: resizeLBRef
          }, null, 512),
          createElementVNode("div", {
            class: "t-point t-point-rb",
            ref_key: "resizeRBRef",
            ref: resizeRBRef
          }, null, 512)
        ])) : createCommentVNode("", true),
        createElementVNode("div", _hoisted_2, [
          __props.showHeader ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: "t-header-container",
            ref_key: "terminalHeaderRef",
            ref: terminalHeaderRef,
            style: normalizeStyle(draggable.value ? "cursor: move;" : ""),
            onDblclick: _fullscreen
          }, [
            renderSlot(_ctx.$slots, "header", {}, () => [
              createVNode(THeader, {
                ...
                onOnClick: _triggerClick
              }, null, 8, ["title", "pinned", "draggable"])
            ])
          ], 36)) : createCommentVNode("", true),
          createElementVNode("div", {
            class: "t-window",
            style: normalizeStyle(`${__props.showHeader ? `height:calc(100% - ${headerHeight.value}px);margin-top: ${headerHeight.value}px;` : "height:100%"}`),
            ref_key: "terminalWindowRef",
            ref: terminalWindowRef,
            onClick: _focus,
            onDblclick: _cache[3] || (_cache[3] = ($event) => _focus(true))
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(terminalLog.value, (item, idx2) => {
              return openBlock(), createElementBlock("div", {
                class: "t-log-box",
                key: idx2
              }, [
                item.type === "cmdLine" ? (openBlock(), createElementBlock("span", _hoisted_3, [
                  ...
                  item.type === "normal" ? (openBlock(), createElementBlock("span", _hoisted_7, [
                    renderSlot(_ctx.$slots, "normal", { message: item }, () => [
                      createVNode(_sfc_main$6, { message: item }, null, 8, ["message"])
                    ])
                  ])) : item.type === "json" ? (openBlock(), createElementBlock("div", _hoisted_8, [
                    renderSlot(_ctx.$slots, "json", { message: item }, () => [
                      createVNode(_sfc_main$5, {
                        message: item,
                        idx: idx2
                      }, null, 8, ["message", "idx"])
                    ])
                  ])) : item.type === "code" ? (openBlock(), createElementBlock("div", _hoisted_9, [
                    renderSlot(_ctx.$slots, "code", { message: item }, () => [
                      createVNode(_sfc_main$4, {
                        message: item,
                        idx: idx2
                      }, null, 8, ["message", "idx"])
                    ])
                  ])) : item.type === "table" ? (openBlock(), createElementBlock("div", _hoisted_10, [
                    renderSlot(_ctx.$slots, "table", { message: item }, () => [
                      createVNode(_sfc_main$3, {
                        message: item,
                        idx: idx2
                      }, null, 8, ["message", "idx"])
                    ])
                  ])) : item.type === "html" ? (openBlock(), createElementBlock("div", _hoisted_11, [
                    renderSlot(_ctx.$slots, "html", { message: item }, () => [
                      createElementVNode("div", {
                        innerHTML: item.content
                      }, null, 8, _hoisted_12)
                    ])
            ...
            flash.open && flash.content ? (openBlock(), createElementBlock("div", _hoisted_13, [
              renderSlot(_ctx.$slots, "flash", {
                content: flash.content
              }, () => [
                createElementVNode("div", {
                  innerHTML: flash.content
                }, null, 8, _hoisted_14)
              ])
            ])) : createCommentVNode("", true),
            ask.open && ask.question ? (openBlock(), createElementBlock("div", _hoisted_15, [
              createElementVNode("div", {
                innerHTML: ask.question,
                style: { "display": "inline-block" }
              }, null, 8, _hoisted_16),
              withDirectives(createElementVNode("input", {
                type: ask.isPassword ? "password" : "text",
                ref_key: "terminalAskInputRef",
                ref: terminalAskInputRef,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => ask.input = $event),
                class: "t-ask-input",
                autofocus: "",
                autocomplete: "off",
                "auto-complete": "new-password",
                onKeyup: withKeys(_onAskInput, ["enter"])
              }, null, 40, _hoisted_17), [
                [vModelDynamic, ask.input]
              ])
            ])) : createCommentVNode("", true),
            withDirectives(createElementVNode("p", {
              class: "t-last-line t-crude-font t-cmd-line",
              ref_key: "terminalInputBoxRef",
              ref: terminalInputBoxRef
            }, [
              createElementVNode("span", {
                class: "t-prompt t-cmd-line-content t-disable-select",
                ref_key: "terminalInputPromptRef",
                ref: terminalInputPromptRef
              }, [
                createElementVNode("span", null, toDisplayString(__props.context), 1),
                createElementVNode("span", null, toDisplayString(__props.contextSuffix), 1)
              ], 512),
              createElementVNode("span", {
                class: "t-cmd-line-content",
                innerHTML: _commandFormatter(command.value)
              }, null, 8, _hoisted_18),
              withDirectives(createElementVNode("span", {
                class: "cursor t-disable-select",
                ref_key: "terminalCursorRef",
                ref: terminalCursorRef,
                style: normalizeStyle(`width:${cursorConf.width}px;left:${cursorConf.left};top:${cursorConf.top};`)
              }, " ", 4), [
                [vShow, cursorConf.show]
              ]),
              withDirectives(createElementVNode("input", {
                type: "text",
                autofocus: "",
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => command.value = $event),
                class: "t-cmd-input t-disable-select",
                ref_key: "terminalCmdInputRef",
                ...
                onKeyup: [
                  _onInputKeyup,
                  withKeys(withModifiers(_switchPreCmd, ["exact"]), ["up"]),
                  withKeys(withModifiers(_switchNextCmd, ["exact"]), ["down"]),
                  withKeys(_execute, ["enter"])
                ],
                onInput: _onInput,
                onFocusin: _cache[2] || (_cache[2] = ($event) => cursorConf.show = true)
              }, null, 40, _hoisted_19), [
                [vModelText, command.value]
              ])
            ], 512), [
              [vShow, showInputLine.value]
            ]),
            renderSlot(_ctx.$slots, "helpCmd", {
              item: searchCmdResult.item
            }, () => [
              createElementVNode("p", _hoisted_20, toDisplayString(searchCmdResult.item ? searchCmdResult.item.usage : ""), 1)
            ])
          ], 36)
        ]),
        __props.enableExampleHint ? (openBlock(), createElementBlock("div", _hoisted_21, [
          renderSlot(_ctx.$slots, "helpBox", {
            showHeader: __props.showHeader,
            item: searchCmdResult.item
          }, () => [
            searchCmdResult.show && searchCmdResult.item && !unref(_screenType)().xs ? (openBlock(), createBlock(_sfc_main$2, {
              key: 0,
              ref_key: "terminalHelpBoxRef",
              ref: terminalHelpBoxRef,
              top: headerHeight.value + 10,
              result: searchCmdResult
            }, null, 8, ["top", "result"])) : createCommentVNode("", true)
          ])
        ])) : createCommentVNode("", true),
        textEditor.open ? (openBlock(), createElementBlock("div", {
          key: 2,
          class: "t-text-editor-container",
          style: normalizeStyle(`${__props.showHeader ? `height:calc(100% - ${headerHeight.value}px);margin-top: ${headerHeight.value}px;` : "height:100%"}`)
        }, [
          renderSlot(_ctx.$slots, "textEditor", { data: textEditor }, () => [
            createVNode(TEditor, {
              config: textEditor,
              modelValue: textEditor.value,
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => textEditor.value = $event),
              onClose: _textEditorClose,
              ref_key: "terminalTextEditorRef",
              ref: terminalTextEditorRef
            }, null, 8, ["config", "modelValue"])
          ])
        ], 4)) : createCommentVNode("", true),
        createElementVNode("span", _hoisted_22, [
          createElementVNode("span", {
            class: "t-cmd-line-content t-disable-select",
            ref_key: "terminalEnFlagRef",
            ref: terminalEnFlagRef
          }, "a", 512),
          createElementVNode("span", {
            class: "t-cmd-line-content t-disable-select",
            ref_key: "terminalCnFlagRef",
            ref: terminalCnFlagRef
          }, "你", 512)
        ])
      ], 6);
    };
...
_sfc_main.install = (app, options) => {
  setOptions(options);
  _sfc_main.$api = TerminalApi2;
  _sfc_main.$Flash = TerminalFlash;
  _sfc_main.$Ask = TerminalAsk;
  app.component(_sfc_main.__name, _sfc_main);
};
const api = TerminalApi2;
const Flash = TerminalFlash;
const Ask = TerminalAsk;
export {
  Ask,
  Flash,
  _sfc_main as Terminal,
  TerminalApi2 as TerminalApi,
  TerminalAsk,
  TerminalFlash,
  store as TerminalStore,
  api,
  configCodemirror,
  configHighlight,
